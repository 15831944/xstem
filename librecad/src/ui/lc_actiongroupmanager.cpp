...
LC_ActionGroupManager::LC_ActionGroupManager(QObject* parent)
    ...
    , spareparts(new QActionGroup(this))
    , board(new QActionGroup(this))
    , layout(new QActionGroup(this))
    , groups(new QActionGroup(this))
    , array(new QActionGroup(this))
    , optimization(new QActionGroup(this))
    , sort(new QActionGroup(this))
    , leadwire(new QActionGroup(this))
    , clean(new QActionGroup(this))
    , processsetup(new QActionGroup(this))
    , flyingcutting(new QActionGroup(this))

{
    ...
    align->setObjectName(QObject::tr("Align"));
    ...
    spareparts->setObjectName(QObject::tr("Spareparts"));
    board->setObjectName(QObject::tr("Board"));
    layout->setObjectName(QObject::tr("Layout"));
    groups->setObjectName(QObject::tr("Groups"));
    array->setObjectName(QObject::tr("Array"));
    optimization->setObjectName(QObject::tr("Optimization"));
    sort->setObjectName(QObject::tr("Sort"));
    leadwire->setObjectName(QObject::tr("Leadwire"));
    clean->setObjectName(QObject::tr("Clean"));
    processsetup->setObjectName(QObject::tr("ProcessSetup"));
    flyingcutting->setObjectName(QObject::tr("FlyingCutting"));
