    ...
    , actionHandler(nullptr)
{
    setObjectName(name);
    setupUi(this);
    teHistory->setPlaceholderText("命令");
    leCommand->setStyleSheet("background:#4d4d4d;height:20px;border:1px solid #6D6D6D");
//    lCommand->setStyleSheet("margin-left:14px;background-color:transparent");
    teHistory->setStyleSheet("background:#4d4d4d;margin-left:14px;border:1px solid #6D6D6D");
    frame->setContentsMargins(0,0,0,0);
    options_button->setFixedHeight(18);
    leCommand->setPlaceholderText(tr(" 命令"));
    QPalette palette = leCommand->palette();
    palette.setColor(QPalette::Normal, QPalette::PlaceholderText, Qt::white);
    leCommand->setPalette(palette);
    teHistory->setPalette(palette);
    leCommand->setFixedWidth(320);
    ...
    options_button->setStyleSheet("QToolButton::menu-indicator { image: none; }"\
                                  "QToolButton { background:#303030; }");
//    this->setFixedSize(322,293);
//    lCommand->setFixedWidth(322);
    frame->setFixedWidth(322);
    teHistory->setFixedWidth(322);
    frame->setStyleSheet("QFrame#frame{margin-left:14px;background-color:transparent}");
    frame->setContentsMargins(0,0,0,0);
