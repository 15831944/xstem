    ...
    : QWidget(parent, fl)
{
    ...
    vboxLayout->setContentsMargins(14,10,0,15);
    ...
    bInsert->setStyleSheet("color:#03f1f1;");
//    vboxLayout->addWidget(bInsert);
    bInsert->setFixedSize(80,20);
    QHBoxLayout *refreshButtonsLayout = new QHBoxLayout(this);
    refreshButtonsLayout->addWidget(bInsert);

    QLabel *label1 = new QLabel;
    label1->setFixedSize(30,20);
    label1->setStyleSheet("background:transparent;");
    refreshButtonsLayout->addWidget(label1);

    bRefresh = new QPushButton(tr("Refresh"), this);
    bRefresh->setFixedSize(80,20);
    bRefresh->setStyleSheet("color:#03f1f1;");
    refreshButtonsLayout->addWidget(bRefresh);

    QLabel *label2 = new QLabel;
    label2->setFixedSize(30,20);
    label2->setStyleSheet("background:transparent;");
    refreshButtonsLayout->addWidget(label2);

    bRebuild = new QPushButton(tr("Rebuild"), this);
    bRebuild->setFixedSize(80,20);
    ...
    bRebuild->setStyleSheet("color:#03f1f1;");
    buildTree();
...
void QG_LibraryWidget::buildTree() {
 ...
 //   dirModel->setHeaderData(1,Qt::Horizontal,QColor(255,0,0),Qt::BackgroundRole);
    scanTree();
//    dirModel->setHeaderData(Qt::BackgroundColorRole,Qt::Vertical,QColor(0,0,255));
    dirView->setModel(dirModel);


    ivPreview->setStyleSheet("margin-top:10px; margin-bottom: 10px;");
