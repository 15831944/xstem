...
//    this->setStyleSheet("margin:0;border:0;padding:0");
    ...
    vScrollBar->setFixedWidth(10);
    hScrollBar->setFixedHeight(10);
    hScrollBar->setStyleSheet("QScrollBar:horizontal{margin:0;padding:0px;width:10px;border-width:0px}\
    ...
    vScrollBar->setStyleSheet("QScrollBar:vertical{margin:0;width:10px;border-width:0px}\
