...
QG_LayerModel::QG_LayerModel(QObject * parent) : QAbstractTableModel(parent) {
    layerVisible = QIcon(":/icons/visible.png");
    layerHidden = QIcon(":/icons/invisible.png");
    layerDefreeze = QIcon(":/icons/unlocked.png");
    layerFreeze = QIcon(":/icons/locked.png");
    layerPrint = QIcon(":/icons/print.png");
    layerNoPrint = QIcon(":/icons/noprint.png");
    layerConstruction = QIcon(":/icons/construction_layer.png");
    layerNoConstruction = QIcon(":/icons/noconstruction.png");
}
...
QG_LayerWidget::QG_LayerWidget(QG_ActionHandler* ah, QWidget* parent,
    ...
    layerView->setMinimumHeight(120);
    QHeaderView *pHeader {layerView->horizontalHeader()};
    pHeader->setMinimumSectionSize( QG_LayerModel::ICONWIDTH + 4);
    pHeader->setStretchLastSection(true);
//    pHeader->setDefaultSectionSize(10);
    pHeader->hide();
//    layerView->horizontalHeader()->setDefaultSectionSize(5);
...
//    layButtons->addWidget(but);
    ...
    matchLayerName->setStyleSheet("border:1px solid #707070");

    QPalette palette = matchLayerName->palette();
    palette.setColor(QPalette::Normal, QPalette::PlaceholderText, Qt::white);
    matchLayerName->setPalette(palette);
...
//    lay->addLayout(layButtons);
    ...
    lay->setContentsMargins(14,10,0,25);
    this->setLayout(lay);
    this->setFixedWidth(322);
    ...
    layerView->verticalScrollBar()->setStyleSheet("QScrollBar:vertical{margin:0;width:10px;border-width:0px}\
    ...
    layerView->horizontalScrollBar()->setStyleSheet("QScrollBar:horizontal{margin:0;padding:0px;width:10px;border-width:0px}\
                                                    QScrollBar::sub-page:horizontal{background-color:#707070;border:0;}\
                                                    QScrollBar::add-page:horizontal{background-color:#707070;border:0;}\
                                                     QScrollBar::handle:horizontal{margin:0;border:0;background:#292929}\
                                                     QScrollBar::sub-line:horizontal{image:none;}\
                                                     QScrollBar::add-line:horizontal{image:none;}"\
                                                  );
}
