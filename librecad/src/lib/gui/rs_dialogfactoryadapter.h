...
public:
    ...
    RS_BlockData requestNewGroupDialog(RS_BlockList*) override {return {};}
    ...
    bool requestScaleDialog(RS_EntityContainer*container,RS_ScaleData&) override {return false;}
