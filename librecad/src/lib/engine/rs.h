...
public:
    ...
    enum ActionType {
        ...
        ActionSelectDouble,
        ActionGetSelect,
        ActionSelectUnclosed,
        ActionSelectExternal,
        ActionSelectSmallSize,


        ActionDefineGroup,
        ActionBreakSelectGroup,
        ActionBreakAllGroup,
        ActionBlocksEdit,
        ...
        /*对齐*/
        ActionAlignLeft,
        ActionAlignLeftNoSelect,
        ActionAlignRight,
        ActionAlignRightNoSelect,
        ActionAlignHorizontal,
        ActionAlignHorizontalNoSelect,
        ActionAlignTop,
        ActionAlignTopNoSelect,
        ActionAlignBottom,
        ActionAlignBottomNoSelect,
        ActionVerticalCenter,
        ActionVerticalCenterNoSelect,
        ActionCenterAlignment,
        ActionCenterAlignmentNoSelect,
        ActionWelianNoSelect,
        ActionModifyMirror,
        ...
        ActionCompensate,//补偿
        ActionFlyingCut,
        ActionFlyingCutNoSelect,//飞切
        ActionFlyingCutArc,
        ActionFlyingCutArcNoSelect,//飞切
        ActionCompensateNoSelect,
        ActionSetWire,
        ActionMerge,//合并相连线
        ActionRemoveSmall,//去除小图形
        ActionMergeNoSelect,
